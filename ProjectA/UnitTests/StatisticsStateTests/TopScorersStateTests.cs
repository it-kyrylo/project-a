...
{
    [TestFixture]
    public class TopScorersStateTests
    {
        ...
        private readonly IState _topScorersState;

        public TopScorersStateTests()
        {
            ...
            this._topScorersState = new TopScorersState(this._stateProviderMock, this._statisticsServiceMock);
        ...
        {
            //Arrange
            var expectedResult = StateType.TopScorersState;

            //Act
            var actualResult = await this._topScorersState.BotOnCallBackQueryReceived(this._botClientMock, this._callbackQueryMock);
        ...
        public async Task BotOnMessageReceived_ShouldReturnCorrectState_IfMessageIsNull(long chatId)
        {
            ...
            //Act
            var actualResult = await this._topScorersState.BotOnMessageReceived(this._botClientMock, this._messageMock);
        ...
        [Test]
        [TestCase(1234556789, "3")]
        [TestCase(1234556789, "0")]
        [TestCase(1234556789, "-1")]
        [TestCase(1234556789, "43")]
