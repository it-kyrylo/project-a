...
{
    [TestFixture]
    public class PlayerDataStateTests
    {
        ...
        private readonly IState _playerDataState;

        public PlayerDataStateTests()
        {
            ...
            this._playerDataState = new PlayerDataState(this._stateProviderMock, this._statisticsServiceMock);
        ...
        {
            //Arrange
            var expectedResult = StateType.PlayerDataState;

            //Act
            var actualResult = await this._playerDataState.BotOnCallBackQueryReceived(this._botClientMock, this._callbackQueryMock);
        ...
        public async Task BotOnMessageReceived_ShouldReturnCorrectState_IfMessageIsNull(long chatId)
        {
            ...
            //Act
            var actualResult = await this._playerDataState.BotOnMessageReceived(this._botClientMock, this._messageMock);
