...
{
    public class PlayersByFormState : IState
    {
        ...
        {
            var suggestedPlayers = await this.playerSuggestionService.GetByCurrentForm(position, minPrice, maxPrice);

            var sb = new StringBuilder();

            sb
                .AppendLine(PlayersByForm)
                .AppendLine();
